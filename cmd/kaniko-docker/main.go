...
func main() {
	...
	app.Flags = []cli.Flag{
		...
		// 因为发布系统需要，增加了以下参数，用于代替REPO
		cli.StringFlag{
			Name:   "repo-path",
			Usage:  "Base repo path",
			EnvVar: "PLUGIN_REPO_PATH",
		},
		cli.StringFlag{
			Name:   "repo-name",
			Usage:  "Repo name",
			EnvVar: "PLUGIN_REPO_NAME",
		},
	}
...
func run(c *cli.Context) error {
	...
	plugin := kaniko.Plugin{
		Build: kaniko.Build{
			...
			Repo:            buildRepoXhj(c.String("repo-name"), c.String("repo-path")),
...
func buildRepoXhj(repoName, repoPath string) string {
	return formatRepoPath(repoPath) + "/" + formatRepoName(repoName)
}

func formatRepoPath(repoPath string) string {
